...
DangersV3 = {
	-- Degei, Aita
    ['フレミングキック'] = {ann='》》》 湾曲連携スタート！！　弱点：水 《《《 <call8>'},
    ['アイシーグラスプ'] = {ann='》》》 核熱連携スタート！！　弱点：火 《《《 <call8>'},
    ['エローディングフレッシュ'] = {ann='》》》 分解連携スタート！！　弱点：風 《《《 <call8>v'},
    ['ファルミナススマッシュ'] = {ann='》》》 重力連携スタート！！　弱点：土 《《《 <call8>'},
    ['フラッシュフラッド'] = {ann='》》》 分解連携スタート！！　弱点：雷 《《《 <call8>'},
    -- ['ヴィヴィセクション'] = {ann='》》》 弱点属性：？、次のＷＳを待っている 《《《'},
	
	-- Leshonn, Gartell
    ['シュリーキングゲイル'] = {ann='》》》 重力連携スタート！！　弱点：土 《《《 <call8>'},
    ['アンジュレティングショックウェーブ'] = {ann='》》》 湾曲連携スタート！！　弱点：氷 《《《 <call8>'},
